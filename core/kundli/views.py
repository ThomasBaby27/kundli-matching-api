...
class KundliMatchView(APIView):
    # valid JWT token submission via 'Authorization: Bearer <token>' header
    ...
    def get(self, request):
        ...
        """
        # Fetch records ordered by the most recent calculations
    ...
    def post(self, request):
        ...
        # Validated data parses your strings into proper python date objects automatically
        ...
        try:
            ...
            # 2. fetch profiles from PostgreSQL
    ...
    def format_response(self, match):
        """Helper function to cleanly format the user match details"""
        return {
